...
def ver():
    ...
    pyverlabel.config(text=f'Python {version_info[0]}.{version_info[1]}.{version_info[2]} 在 {system()} 上' )# version_info[0] is major, version_info[1] is minor, version_info[2] is patch
